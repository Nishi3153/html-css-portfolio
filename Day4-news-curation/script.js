    ...
    return [
        {
            ...
            summary: "量子物理学は100年間、あらゆる実験で成功を収めていますが、その解釈をめぐって物理学者たちの意見は一致していません。量子理論が現実をどのように記述するのか、あるいはそもそも記述できるのかさえ、合意が得られていないのです。これは、量子力学が極めて成功した理論であるにも関わらず、その根底にある現実の解釈が複数存在し、どれが正しいのか、あるいは複数の解釈が全て正しいのかが不明であることを意味します。この不一致は、量子力学の基礎的な理解を深める上で重要な課題であり、量子コンピューティングなどの応用技術の発展にも影響を与える可能性があります。  つまり、量子世界の謎解きは未だ途上であり、その解明は科学技術の未来を大きく変える可能性を秘めているのです。",
